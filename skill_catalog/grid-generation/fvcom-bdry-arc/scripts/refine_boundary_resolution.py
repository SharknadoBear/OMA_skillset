...
from fvcom_bdry_arc import BoundaryResolutionConfig, build_boundary_resolution  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--profile", choices=("adaptive-coastal-v1",), default="adaptive-coastal-v1")
    ...
    manifest = build_boundary_resolution(
        ...
        args.run_dir,
        args.name,
        BoundaryResolutionConfig(profile=args.profile),
    )
